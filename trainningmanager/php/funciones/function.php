<?php
	...
	function login($pass,$us){
		$pass = hash('md5',$pass);
		$lista = ordensql("SELECT pass from login WHERE entrenador='".$us."' AND pass='".$pass."'");
		//var_dump($lista);
	...
	function comprueba(){
		if(!($_SESSION["login"]=="yes")){
			header("location:http://localhost/trainningmanager/index.php");
		}
	}
	...
	//FUNCIÓN DE INDEX PARA MIRAR SI HAY PAGOS PENDIENTES
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="http://localhost/trainningmanager/tarifas/tarifas.php">Tarifas</a>
                    </li>
                    <li class="dropdown">
