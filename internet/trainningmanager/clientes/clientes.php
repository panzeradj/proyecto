...
$banderaBaja=false; 
	...
	{
		$banderaBaja=true;
		echo "<div class='letraOscura'><h1>Clientes activos</h1><form name='a' method=get action='http://acwellness.es/trainningmanager/clientes/Clientes.php'><input type='hidden' name=baja value=a><input type=submit name=a value='Clientes inactivos'></form></div>";
	...
	else
	{
		echo "<div class='letraOscura'><h1>Clientes inactivos</h1>";
			echo "<form name='a' method=post action='http://acwellness.es/trainningmanager/clientes/Clientes.php'><input type=submit name=asd value='Clientes activos'></form></div>";
	...
	if($banderaBaja )
	{
		echo "<div class='busqueda'><form action='http://acwellness.es/trainningmanager/clientes/Clientes.php' method=POST name=buasdsqueda><input type=text name=busqueda ><input type=submit name=enviar></form></div>";
	...
	{
		echo "<div class='busqueda'><form action='http://acwellness.es/trainningmanager/clientes/Clientes.php?baja=a' method=POST name=buasdsqueda><input type=text name=busqueda > <input type=hidden name='noActivo' value='asd'><input type=submit name=enviar></form></div>";
		$sql="select id_cliente , nombre, dni, genero, fecha_nacimiento , email
        from clientes 
        where activo=0";
	}
